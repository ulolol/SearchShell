...
class SearchShell(cmd.Cmd):
    ...
    def do_search(self, arg):
        ...
        try:
            ...
            response = self.wrapper.query_openai(query, context)
            print("\nResponse:")
            print(response)
...
class OpenAIWebWrapper:
    def __init__(self, model_name: str = "gpt-4o-mini"):
        ...
        self.ddgs = DDGS() # Initialize the DDGS object here
    ...
    def query_openai(self, prompt: str, context: str) -> str:
